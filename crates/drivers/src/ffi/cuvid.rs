...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _CUVIDDECODECREATEINFO"][::std::mem::size_of::<_CUVIDDECODECREATEINFO>() - 176usize];
    ...
    ["Offset of field: _CUVIDDECODECREATEINFO::ulHeight"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ulHeight) - 8usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::ulNumDecodeSurfaces"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ulNumDecodeSurfaces) - 16usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::CodecType"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, CodecType) - 24usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::ChromaFormat"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ChromaFormat) - 28usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::ulCreationFlags"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ulCreationFlags) - 32usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::bitDepthMinus8"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, bitDepthMinus8) - 40usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::ulIntraDecodeOnly"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ulIntraDecodeOnly) - 48usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::ulMaxWidth"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ulMaxWidth) - 56usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::ulMaxHeight"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ulMaxHeight) - 64usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::Reserved1"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, Reserved1) - 72usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::display_area"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, display_area) - 80usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::OutputFormat"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, OutputFormat) - 88usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::DeinterlaceMode"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, DeinterlaceMode) - 92usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::ulTargetWidth"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ulTargetWidth) - 96usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::ulTargetHeight"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ulTargetHeight) - 104usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::ulNumOutputSurfaces"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, ulNumOutputSurfaces) - 112usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::vidLock"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, vidLock) - 120usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::target_rect"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, target_rect) - 128usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::enableHistogram"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, enableHistogram) - 136usize];
    ["Offset of field: _CUVIDDECODECREATEINFO::Reserved2"]
        [::std::mem::offset_of!(_CUVIDDECODECREATEINFO, Reserved2) - 144usize];
};

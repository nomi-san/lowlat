...
| D7 | **v1 codecs are H.264 and HEVC, 8-bit 4:2:0.** Encoder backends are NVENC first, then FFmpeg software loaded dynamically. 10-bit and 4:4:4 are deferred, but their wire flag bits are reserved now so adding them later is not a wire change. |
